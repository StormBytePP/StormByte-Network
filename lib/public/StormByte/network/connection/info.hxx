...
namespace StormByte::Network::Connection {
	...
	/**
	 * @enum class ReadMode
	 * @brief The enum class representing the read mode.
	 */
	enum class STORMBYTE_NETWORK_PUBLIC ReadMode: int {
		NonBlocking 	= 0,															///< The non-blocking read mode.
		Blocking 		= 1																///< The blocking read mode.
	};
